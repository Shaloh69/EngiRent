...
// "Campus Day" mode (warm off-white, not stark white). Identical values to
// client/admin/src/app/theme.ts — same palette, duplicated rather than
// shared because client/admin and client/web are independent npm packages
// with no monorepo/shared-package setup; introducing one just for a theme
// object would be more machinery than this repo's structure currently needs.
